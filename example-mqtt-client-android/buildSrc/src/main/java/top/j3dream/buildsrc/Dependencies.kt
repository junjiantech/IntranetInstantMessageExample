...
object Dependencies {
    ...
    object AndroidX {
        ...
        const val LegacySupportV4 =
            "androidx.legacy:legacy-support-v4:${DepVersion.LegacySupportV4}"
    }

    object Google {
        const val Material = "top.google.android.material:material:${DepVersion.Material}"
        const val AutoService = "top.google.auto.service:auto-service:${DepVersion.AutoService}"
        const val AutoServiceAnnotations =
            "top.google.auto.service:auto-service-annotations:${DepVersion.AutoService}"
    }
    ...
    object Network {
        ...
        const val MQTT = "com.github.hannesa2:paho.mqtt.android:${DepVersion.MQTT}"
    }
